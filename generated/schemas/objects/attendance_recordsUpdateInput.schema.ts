...
import { studentsUpdateOneRequiredWithoutAttendance_recordsNestedInputObjectSchema as studentsUpdateOneRequiredWithoutAttendance_recordsNestedInputObjectSchema } from './studentsUpdateOneRequiredWithoutAttendance_recordsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  students: z.lazy(() => studentsUpdateOneRequiredWithoutAttendance_recordsNestedInputObjectSchema).optional()
}).strict();
export const attendance_recordsUpdateInputObjectSchema: z.ZodType<Prisma.attendance_recordsUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.attendance_recordsUpdateInput>;
export const attendance_recordsUpdateInputObjectZodSchema = makeSchema();
