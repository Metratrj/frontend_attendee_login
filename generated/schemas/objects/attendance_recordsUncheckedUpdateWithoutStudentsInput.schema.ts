...
const makeSchema = () => z.object({
  ...
  session_token: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  created_at: z.union([z.coerce.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional()
}).strict();
export const attendance_recordsUncheckedUpdateWithoutStudentsInputObjectSchema: z.ZodType<Prisma.attendance_recordsUncheckedUpdateWithoutStudentsInput> = makeSchema() as unknown as z.ZodType<Prisma.attendance_recordsUncheckedUpdateWithoutStudentsInput>;
export const attendance_recordsUncheckedUpdateWithoutStudentsInputObjectZodSchema = makeSchema();
