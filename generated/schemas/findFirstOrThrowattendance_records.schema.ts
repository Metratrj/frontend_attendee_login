...
export const attendance_recordsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.attendance_recordsSelect> = z.object({
...
export const attendance_recordsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student_id: z.boolean().optional(),
    login_time: z.boolean().optional(),
    status: z.boolean().optional(),
