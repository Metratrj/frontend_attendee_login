...
export const daily_configurationsFindManySelectSchema: z.ZodType<Prisma.daily_configurationsSelect> = z.object({
    date: z.boolean().optional(),
    late_cutoff_time: z.boolean().optional(),
    created_at: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.daily_configurationsSelect>;

export const daily_configurationsFindManySelectZodSchema = z.object({
    date: z.boolean().optional(),
    late_cutoff_time: z.boolean().optional(),
    created_at: z.boolean().optional()
  }).strict();

export const daily_configurationsFindManySchema: z.ZodType<Prisma.daily_configurationsFindManyArgs> = z.object({ select: daily_configurationsFindManySelectSchema.optional(),  orderBy: z.union([daily_configurationsOrderByWithRelationInputObjectSchema, daily_configurationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: daily_configurationsWhereInputObjectSchema.optional(), cursor: daily_configurationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DailyConfigurationsScalarFieldEnumSchema, DailyConfigurationsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.daily_configurationsFindManyArgs>;

export const daily_configurationsFindManyZodSchema = z.object({ select: daily_configurationsFindManySelectSchema.optional(),  orderBy: z.union([daily_configurationsOrderByWithRelationInputObjectSchema, daily_configurationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: daily_configurationsWhereInputObjectSchema.optional(), cursor: daily_configurationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DailyConfigurationsScalarFieldEnumSchema, DailyConfigurationsScalarFieldEnumSchema.array()]).optional() }).strict();