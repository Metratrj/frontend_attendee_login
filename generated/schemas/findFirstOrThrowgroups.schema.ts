...
export const groupsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.groupsSelect> = z.object({
...
export const groupsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    created_at: z.boolean().optional(),
    updated_at: z.boolean().optional(),
