...
export const attendance_recordsFindFirstSelectSchema: z.ZodType<Prisma.attendance_recordsSelect> = z.object({
...
export const attendance_recordsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student_id: z.boolean().optional(),
    login_time: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const attendance_recordsFindFirstSchema: z.ZodType<Prisma.attendance_recordsFindFirstArgs> = z.object({ select: attendance_recordsFindFirstSelectSchema.optional(), include: z.lazy(() => attendance_recordsIncludeObjectSchema.optional()), orderBy: z.union([attendance_recordsOrderByWithRelationInputObjectSchema, attendance_recordsOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendance_recordsWhereInputObjectSchema.optional(), cursor: attendance_recordsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendanceRecordsScalarFieldEnumSchema, AttendanceRecordsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.attendance_recordsFindFirstArgs>;

export const attendance_recordsFindFirstZodSchema = z.object({ select: attendance_recordsFindFirstSelectSchema.optional(), include: z.lazy(() => attendance_recordsIncludeObjectSchema.optional()), orderBy: z.union([attendance_recordsOrderByWithRelationInputObjectSchema, attendance_recordsOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendance_recordsWhereInputObjectSchema.optional(), cursor: attendance_recordsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendanceRecordsScalarFieldEnumSchema, AttendanceRecordsScalarFieldEnumSchema.array()]).optional() }).strict();